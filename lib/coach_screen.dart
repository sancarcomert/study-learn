...
class _CoachScreenState extends ConsumerState<CoachScreen> {
  ...
  static const List<String> _hostilePhrases = [
    ...
    'yavşak', 'yavsak', 'ibne', 'pezevenk',
    'sürtük', 'surtuk', 'kaltak', 'it oğlu', 'it oglu',
    'namussuz', 'haysiyetsiz', 'şıllık', 'sillik',
    'boktan', 'sik kafalı', 'sik kafali',
    'yarrak', 'yarrağı', 'yarragi', 'kevaşe', 'kevase',
    'ezik', 'zibidi', 'ergen', 'çocuk musun', 'cocuk musun',
    'sen ne anlarsın', 'sen ne anlarsin', 'işe yaramaz', 'ise yaramaz',
    'saçmalıyorsun', 'sacmaliyorsun', 'zırvalıyorsun', 'zirvaliyorsun',
    'boş konuşuyorsun', 'bos konusuyorsun', 'kapa çeneni', 'kapa ceneni',
    'sus artık', 'sus artik', 'defol',
  ];
  ...
  static const List<String> _contentRequestPhrases = [
    ...
    'ders anlat', 'konu anlat', 'bana öğret', 'bana ogret',
    'öğretir misin', 'ogretir misin', 'anlatır mısın', 'anlatir misin',
    'açıklar mısın', 'aciklar misin', 'izah et', 'izah eder misin',
    'formülü söyle', 'formulu soyle', 'formül nedir', 'formul nedir',
    'formülünü ver', 'formulunu ver',
    'tarif et', 'tarif eder misin',
    'örnek çöz', 'ornek coz', 'örnek ver', 'ornek ver',
    'soru sor', 'soru çöz', 'soru coz', 'bu soruyu çöz', 'bu soruyu coz',
    'bu soruyu yapar mısın', 'bu soruyu yapar misin',
    'cevabı ver', 'cevabi ver', 'sonucu bul', 'sonucu söyle', 'sonucu soyle',
    'yardım et bu soruda', 'yardim et bu soruda',
    'bilmiyorum nasıl yapılır', 'bilmiyorum nasil yapilir',
    'anlatım videosu', 'anlatim videosu', 'ders videosu',
    'video at', 'link at', 'kaynak öner', 'kaynak oner',
    'pdf at', 'özet çıkar', 'ozet cikar', 'özetle', 'ozetle',
    'tekrar anlat', 'bir daha anlat', 'nasıl hesaplanır', 'nasil hesaplanir',
    'nasıl bulunur', 'nasil bulunur', 'kuralını söyle', 'kuralini soyle',
  ];
  ...
  static const List<String> _examFearPhrases = [
    ...
    'çakacağım', 'cakacagim', 'çakarım', 'cakarim',
    'düşük alacağım', 'dusuk alacagim',
    'sıfır çekerim', 'sifir cekerim', 'boş geçerim', 'bos gecerim',
    'yeterli değilim', 'yeterli degilim',
    'başaramayacağım', 'basaramayacagim',
    'elenirim', 'elenmek',
    'geçemeyeceğim', 'gecemeyecegim',
    'kazanamayacağım', 'kazanamayacagim',
    'netlerim düşük', 'netlerim dusuk', 'netim düşecek', 'netim dusecek',
    'hedefe ulaşamam', 'hedefe ulasamam',
    'hayalim suya düşecek', 'hayalim suya dusecek',
    'çok geriden geliyorum', 'cok geriden geliyorum',
    'yetişemiyorum', 'yetisemiyorum', 'vakit yetmiyor', 'zaman yetmiyor',
    'çok az vaktim kaldı', 'cok az vaktim kaldi',
    'sınava az kaldı korkuyorum', 'sinava az kaldi korkuyorum',
    'stres yapıyorum sınavdan', 'stres yapiyorum sinavdan',
    'sınav stresim', 'sinav stresim',
    'içim rahat değil sınav için', 'icim rahat degil sinav icin',
    'beynim durdu', 'panikliyorum', 'panik atak', 'panik oluyorum',
    'tir tir titriyorum',
    'elim ayağım titriyor', 'elim ayagim titriyor',
    'midem bulanıyor sınav', 'midem bulaniyor sinav',
    'sınav kaygısı', 'sinav kaygisi', 'içim içimi yiyor', 'icim icimi yiyor',
  ];
  ...
  static const List<String> _comparisonPhrases = [
    ...
    'komşunun çocuğu', 'komsunun cocugu',
    'arkadaşlarım çok önde', 'arkadaslarim cok onde',
    'herkes bitirmiş', 'herkes bitirmis', 'herkes yaptı bile',
    'herkes yapti bile',
    'ben geride kaldım', 'ben geride kaldim',
    'başkaları daha hızlı', 'baskalari daha hizli',
    'çevremdeki herkes', 'cevremdeki herkes',
    'sınıf birincisi', 'sinif birincisi',
    'o kadar iyi değilim', 'o kadar iyi degilim',
    'ondan kötüyüm', 'ondan kotuyum',
    'onunla kıyaslanınca', 'onunla kiyaslaninca',
    'herkes benden ileride', 'rakiplerim benden iyi',
    'diğerleri benden iyi', 'digerleri benden iyi',
    'arkadaşım kazanacak', 'arkadasim kazanacak',
    'ben kazanamayacağım', 'ben kazanamayacagim',
    'başkalarıyla kıyaslıyorum', 'baskalariyla kiyasliyorum',
    'kendimi başkalarıyla', 'kendimi baskalariyla',
  ];
  ...
  static const List<String> _negativeSubjectSentiment = [
    ...
    'iğreniyorum', 'igreniyorum', 'tiksiniyorum',
    'çok sıkıcı', 'cok sikici', 'sıkıcı geliyor', 'sikici geliyor',
    'anlam veremiyorum',
    'kafama girmiyor', 'hiç girmiyor kafama', 'hic girmiyor kafama',
    'beynim almıyor', 'beynim almiyor',
    'saçma geliyor', 'sacma geliyor', 'mantıksız geliyor',
    'mantiksiz geliyor',
    'yapamıyorum bu dersi', 'yapamiyorum bu dersi',
    'beceremiyorum', 'çuvallıyorum', 'cuvalliyorum',
    'sıfır çekiyorum bu dersten', 'sifir cekiyorum bu dersten',
    'en kötü dersim', 'en kotu dersim',
    'en zayıf olduğum ders', 'en zayif oldugum ders',
    'asla anlamayacağım', 'asla anlamayacagim',
    'kafam basmıyor', 'kafam basmiyor',
    'beynim yanıyor', 'beynim yaniyor',
    'bu ders beni bitiriyor', 'bu ders yıpratıyor', 'bu ders yipratiyor',
    'korkuyorum bu dersten', 'bu dersten nefret',
    'bu derse alerjim var', 'içim kaldırmıyor', 'icim kaldirmiyor',
    'kabus gibi', 'çile gibi', 'cile gibi',
  ];
  ...
  static const List<String> _positiveSubjectSentiment = [
    ...
    'çok seviyorum', 'cok seviyorum',
    'en güçlü dersim', 'en guclu dersim',
    'en iyi olduğum ders', 'en iyi oldugum ders',
    'keyif alıyorum', 'keyif aliyorum', 'zevk alıyorum', 'zevk aliyorum',
    'eğlenceli geliyor', 'eglenceli geliyor',
    'çok yatkınım', 'cok yatkinim',
    'doğal yeteneğim var', 'dogal yetenegim var',
    'rahat anlıyorum', 'rahat anliyorum',
    'hemen kavrıyorum', 'hemen kavriyorum',
    'çabuk öğreniyorum', 'cabuk ogreniyorum',
    'favori dersim', 'gözde dersim', 'gozde dersim',
    'harika gidiyorum', 'süper gidiyorum', 'super gidiyorum',
    'yüksek net alıyorum', 'yuksek net aliyorum',
    'çok başarılıyım', 'cok basariliyim', 'gayet iyiyim bu derste',
  ];
  ...
  static const List<String> _greetingPhrases = [
    ...
    'selamlar', 'merhabalar', 'mrb', 'slm', 'hello',
  ...
  static const List<String> _wellbeingCheckPhrases = [
    ...
    'keyifler nasıl', 'keyifler nasil', 'ne var ne yok',
    'naber ne var ne yok', 'iyi misiniz',
    'moralin nasıl', 'moralin nasil', 'moral nasıl', 'moral nasil',
  ...
  static const List<String> _botIdentityPhrases = [
    ...
    'chatgpt misin', 'chat gpt misin', 'gpt misin', 'claude misin',
    'openai mısın', 'openai misin',
    'bir program mısın', 'bir program misin', 'kod musun',
    'algoritma mısın', 'algoritma misin',
    'gerçek insan mısın', 'gercek insan misin',
    'arkanda kim var', 'seni kim yaptı', 'seni kim yapti',
    'seni kim yazdı', 'seni kim yazdi',
  ...
  static const List<String> _casualCheckInPhrases = [
    ...
    'ne yapıyorsun şu an', 'ne yapiyorsun su an',
    'boş musun', 'bos musun', 'meşgul müsün', 'mesgul musun',
  ...
  static const List<String> _jokePhrases = [
    ...
    'komik bir şey söyle', 'komik bir sey soyle',
  ...
  static const List<String> _usageConfusionPhrases = [
    ...
    'bu uygulama ne işe yarıyor', 'bu uygulama ne ise yariyor',
    'nasıl görev eklerim', 'nasil gorev eklerim',
    'nasıl plan yaparım', 'nasil plan yaparim',
    'ne yazacağımı bilmiyorum', 'ne yazacagimi bilmiyorum',
    'buraya ne yazmalıyım', 'buraya ne yazmaliyim',
    'kullanmayı bilmiyorum', 'kullanmayi bilmiyorum',
    'ilk defa kullanıyorum', 'ilk defa kullaniyorum',
